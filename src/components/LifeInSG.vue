<template>
  <div class="row">
  	...
  	<div class="col-md-9 col-xs-12 content invisible-scrollbar">
 		<div id="week-01">
 			<div class="content__title">
	  		...
	  		<div class="content__content">
	  			...
	  			<div class="content__content--image mixed-triple">
	  				...
	  				<div class="mixed-triple__annotation">1) We put all the food and daily supplies in the baggage to be delivered. 2) We do the barbage classification together. There were lots of garbage and losts of plastic bags being used. I think maybe a more eco-friendly way would be better. 3) Me, Kwangho and Ronald.</div>
	  			</div>
	 		</div>
  		</div>
  	</div>
