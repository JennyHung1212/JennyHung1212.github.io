<template>
  <div id="sg-week-07" class="content">
    <div class="content__title">
      A Week Full of Love and Adventure
      <img v-lazy="'../../assets/images/vertical_bars_sg.png'" />
    </div>
    <div class="content__date">2019/03/04 ~ 2019/03/10</div>
    <div class="content__content">
      <div class="schedule">
        <span>03/07</span> Changi Airport → Lau Pa Sat
        <br />
        <br />
      ...
      <div class="content__content--image">
        <div class="desktop-img horizontal-double">
          <div class="horizontal-double__frame1 inline-block img_lightbox">
            <a href data-lightbox="week07-1">
              <img v-lazy="'../../assets/images/week07/river1.jpg'" />
            </a>
          </div>
          <div class="horizontal-double__frame2 inline-block img_lightbox">
            <a href data-lightbox="week07-1">
              <img v-lazy="'../../assets/images/week07/river2.jpg'" />
            </a>
          </div>
      ...
      <div
        class="content__content--text"
      >The Night Safari was even more fun! We got to explore the life of nocturnal animals. We first walked around the park on feet. Sometimes it was really hard to spot on the animals because it was really dark. After walking around, we hopped on the car that goes around the park. The car took us to a different area which was outside the walking zone. We saw some Malayan tapirs and deers walking on the street and heard some mighty roar of the male lions. After walking whole day, we were both very exhausted but we both agreed that the parks were worth the money and worth the time.</div>
      <br />
      <br />
      <div class="schedule">
      ...
      <div class="content__content--image">
        <div class="desktop-img horizontal-double">
          ...
          >
            <a href data-lightbox="week07-5">
              <img v-lazy="'../../assets/images/week07/tiantian.jpg'" />
            </a>
          </div>
          <div
          ...
          >
            <a href data-lightbox="week07-5">
              <img v-lazy="'../../assets/images/week07/chicken.jpg'" />
            </a>
          </div>
          <div class="horizontal-double__frame1 inline-block img_lightbox">
            <a href data-lightbox="week07-5">
              <img v-lazy="'../../assets/images/week07/temple.jpg'" />
            </a>
          </div>
          <div class="horizontal-double__frame2 inline-block img_lightbox">
            <a href data-lightbox="week07-5">
              <img v-lazy="'../../assets/images/week07/jamae.jpg'" />
            </a>
          </div>
          <div
            class="horizontal-double__annotation"
          >1) 天天海南雞飯. 2) The best chicken rice I've ever had so far!. 3) Buddha Tooth Relic Temple 佛牙寺龍華院. 4) Masjid Jamae 詹美回教堂.</div>
        </div>
        <div class="mobile-img swiper-container">
          <div class="swiper-wrapper">
            <div class="swiper-slide">
