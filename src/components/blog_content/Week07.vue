<template>
	<div id="sg-week-07" class="content" style="display: none">
		<div class="content__title">
			A Week Full of Love and Adventure<img src="../../assets/images/vertical_bars_sg.png"/>
		</div>
		...
		<div class="content__content">
			<div class="schedule">
				<span>03/07</span> Changi Airport → Lau Pa Sat<br><br>
			...
			<div class="content__content--image horizontal-single">
				<div class="horizontal-single__frame img_lightbox">
					<a href="" data-lightbox="week07-2"><img src="../../assets/images/week07/YMCA.jpg"/></a>
				</div>
			...
			<div class="content__content--image horizontal-single">
				<div class="horizontal-single__frame img_lightbox">
					<a href="" data-lightbox="week07-4"><img src="../../assets/images/week07/mosque.jpg"/></a>
				</div>
			...
			<div class="content__content--image horizontal-single">
				<div class="horizontal-single__frame img_lightbox">
					<a href="" data-lightbox="week07-6"><img src="../../assets/images/week07/50.jpg"/></a>
				</div>
				<div class="horizontal-single__annotation">It was the 50 years anniversary for Sesame Street.</div>
			</div>
		</div>
	</div>
</template>
