	...
	<div id="sg-week-04" class="content" style="display: none">
		...
		<div class="content__content">
			...
			<div class="content__content--image">
				...
				<div class="mobile-img swiper-container">
					<div class="swiper-wrapper">
						<div class="swiper-slide"><img src="../../assets/images/week04/appetizer.jpg"/></div>
						<div class="swiper-slide"><img src="../../assets/images/week04/main.jpg"/></div>
					</div>
			...
			<div class="content__content--image">
				...
				<div class="mobile-img swiper-container">
					<div class="swiper-wrapper">
						<div class="swiper-slide"><img src="../../assets/images/week04/lizard.jpg"/></div>
						<div class="swiper-slide"><img src="../../assets/images/week04/largest_flower.jpg"/></div>
					</div>
					<div class="swiper-button-next"></div>
    			<div class="swiper-button-prev"></div>
				</div>
			...
			<div class="content__content--image">
				...
				<div class="mobile-img swiper-container">
					<div class="swiper-wrapper">
						<div class="swiper-slide"><img src="../../assets/images/week04/day.jpg"/></div>
						<div class="swiper-slide"><img src="../../assets/images/week04/night.jpg"/></div>
					</div>
					<div class="swiper-button-next"></div>
    			<div class="swiper-button-prev"></div>
				</div>
