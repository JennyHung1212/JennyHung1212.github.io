<template>
  <div id="sg-week-04" class="content">
    ...
    <div class="content__content">
        ...
        <div class="desktop-img mixed-triple">
          ...
          <div class="inline-block">
            <div class="mixed-triple__frame2 img_lightbox">
              <a href data-lightbox="week04-1">
                <img v-lazy="'../../assets/images/week04/appetizer.jpg'" />
              </a>
            </div>
            <div class="mixed-triple__frame3 img_lightbox">
              <a href data-lightbox="week04-1">
                <img v-lazy="'../../assets/images/week04/main.jpg'" />
              </a>
            </div>
          </div>
          <div
            class="mixed-triple__annotation"
          >1) Gordon Ramsay. 2) Appetizers 3) Main Dishes. The duck leg was especially good.</div>
        </div>
      ...
      <div class="content__content--image">
        <div class="desktop-img mixed-triple">
          ...
          <div class="inline-block">
            <div class="mixed-triple__frame2 img_lightbox">
              <a href data-lightbox="week04-3">
                <img v-lazy="'../../assets/images/week04/lizard.jpg'" />
              </a>
            </div>
            <div class="mixed-triple__frame3 img_lightbox">
              <a href data-lightbox="week04-3">
                <img v-lazy="'../../assets/images/week04/largest_flower.jpg'" />
              </a>
            </div>
          </div>
          <div
            class="mixed-triple__annotation"
          >1) Common Crowned Pigeon. 2) Inguana (forgot which type) 3) The worlds's largest flower!.</div>
        </div>
        <div class="mobile-img swiper-container">
          <div class="swiper-wrapper">
            <div class="swiper-slide">
      ...
      <div
        class="content__content--text"
      >Let's directly jump to Saturday! I woke up early and joined the second CIP event of TFI LEaRN Programme. It was the Makan Felloship held by YMCA Singapre. Around 60 elders joined the event. We helped to decorate the room, chat with the elders and play fun games with them. The two old ladies sit besides me speak 福建話, which is a dialect in Singapre, and is quite similar to Taiwanese. I'm really glad that Taiwanese come in handy while I'm far away from Taiwan.</div>
      <div class="content__content--image horizontal-single">
        <div class="horizontal-single__frame img_lightbox">
          <a href data-lightbox="week04-5">
            <img v-lazy="'../../assets/images/week04/yusheng.jpg'" />
          </a>
        </div>
        <div
          class="horizontal-single__annotation"
        >We ate yusheng and celebrated Chinese New Year together.</div>
      </div>
      <div
        class="content__content--text"
      >After the CIP event, I went to Sentosa to play beach volleyball. This is my first volleyball play after I dropped out off the volleyball team of my department in NTU. So I was rusty and didn't play quite well. However the weather is really nice, and others players are friendly. I wore out after playing for two hours. I think it's because I haven't do intense exercise and slept very little the day before. Maybe next day I will join them again with my full energy!</div>
    </div>
  </div>
</template>
