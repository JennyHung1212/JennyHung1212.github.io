<template>
  <div id="sg-week-05" class="content">
    <div class="content__title">
      Night Cycling
      <img v-lazy="'../../assets/images/vertical_bars_sg.png'" />
    </div>
    <div class="content__date">2019/02/18 ~ 2019/02/24</div>
    <div class="content__content">
      <div class="content__content--text">
        ...
        <br />
        <br />Next two days were my local-food-tasting days. I had Yong Tau Foo (釀豆腐) at Tampines on Wednesday. Yong tau foo is a Hakka Chinese cuisine consisting primarily of tofu filled with ground meat mixture or fish paste. There were also lots of vegetables to choose from. It's definitely on of my top three local food.
      </div>
      <div class="content__content--image horizontal-single">
        <div class="horizontal-single__frame img_lightbox">
          <a href data-lightbox="week05-1">
            <img v-lazy="'../../assets/images/week05/taufoo.jpg'" />
          </a>
        </div>
        <div
          class="horizontal-single__annotation"
        >Variation of 釀豆腐 include vegetables and mushrooms stuffed with ground meat or surimi. It can be eaten in numerous ways, either dry with a sauce or served as a soup dish.</div>
      </div>
      <div
        class="content__content--text"
      >I went to Old Airport Road Food Court on Thursday, which is recommended by a local student. Old Airport Road FC has a great variety of food to choose from, and the price is really reasonable. I had mango-dragonfruit juice, hokkien fried mee (福建蝦麵) and Cheong Fun (腸粉). The interesting thing about hokkien fried mee is that it's wrapped in paper! I think I will visit there again soon, and maybe go see a movie after that as well.</div>
      <div class="content__content--image">
        <div class="desktop-img mixed-triple">
          <div class="inline-block">
            <div class="mixed-triple__frame1 img_lightbox">
              <a href data-lightbox="week05-2">
                <img v-lazy="'../../assets/images/week05/drink.jpg'" />
              </a>
            </div>
          </div>
          <div class="inline-block">
            <div class="mixed-triple__frame2 img_lightbox">
              <a href data-lightbox="week05-2">
                <img v-lazy="'../../assets/images/week05/mee.jpg'" />
              </a>
            </div>
            <div class="mixed-triple__frame3 img_lightbox">
              <a href data-lightbox="week05-2">
                <img v-lazy="'../../assets/images/week05/fun.jpg'" />
              </a>
            </div>
          </div>
          <div
            class="mixed-triple__annotation"
          >1) The color of the drink was beautiful and taste super good. 2) There were many shrimps in it! Definitely worth the price. 3) 叉燒腸粉 and 雞蛋腸粉.</div>
        </div>
