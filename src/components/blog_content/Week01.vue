<template>
	<div id="sg-week-01" class="content scrolled">
		<div class="content__title">
			First Week First<img src="../../assets/images/vertical_bars_sg.png"/>
		</div>
		...
		<div class="content__content">
			...
			<div class="content__content--image">
				...
				<div class="mobile-img swiper-container">
					<div class="swiper-wrapper">
						<div class="swiper-slide"><img src="../../assets/images/week01/chinatown.jpg"/></div>
						<div class="swiper-slide"><img src="../../assets/images/week01/teamates.jpg"/></div>
					</div>
			...
			<div class="content__content--image">
				...
				<div class="mobile-img swiper-container">
					<div class="swiper-wrapper">
						<div class="swiper-slide"><img src="../../assets/images/week01/CIP-2.jpg"/></div>
						<div class="swiper-slide"><img src="../../assets/images/week01/CIP-3.jpg"/></div>
					</div>
					<div class="swiper-button-next"></div>
    			<div class="swiper-button-prev"></div>
				</div>
